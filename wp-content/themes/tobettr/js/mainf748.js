...
$(document).ready(function(){
	            ...
	            <div class="gallerybox">\
	                <div class="glide">\
	                    <div class="glide__arrows">\
	                        <button class="glide__arrow prev" data-glide-dir="<"><i class="iconfont">&#xe6a9;</i></button>\
	                        <button class="glide__arrow next" data-glide-dir=">"><i class="iconfont">&#xe6ac;</i></button>\
	                    </div>\
	                ...
	                <div class="gallerybox-close" onclick="javascript:TBUI.gallerybox_close();"><i class="iconfont">&#xe627;</i></div>\
	            </div>\
	        ')
	    }
    ...
    // ROLLBAR
	TBUI.bd.append('<div class="rollbar">'+ (is_page('comment-open') ? '<div class="rollbar-item" etap="to_comments"><i class="iconfont">&#xe655;</i></div>' : '') +'<div class="rollbar-item" etap="to_top"><i class="iconfont">&#xe619;</i></div></div>')
...
//                });
        ...
        if( $.inArray(pid, likes.split('.'))!==-1 ) alert("你已赞");  
//            swal({
//                    title: '你已赞',
//                    type: 'warning',
//                    text: '2秒后自动关闭',
